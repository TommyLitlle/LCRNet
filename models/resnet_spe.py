...
class DSELayer(nn.Module):
    ...
    def forward(self, x):  
        ...
        #print(y.size())
        out = sparsemax(y,dim=1).view(b, c, 1, 1)
...
def spe_resnet18(pretrained=False, **kwargs):
...
def spe_resnet34(pretrained=False, **kwargs):
...
def spe_resnet50(pretrained=False, **kwargs):
...
def spe_resnet101(pretrained=False, **kwargs):
